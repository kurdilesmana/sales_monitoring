    ...
    <div class="box box-info">
      ...
      <form class="form-horizontal" action="<?php echo base_url() . 'sales/add'; ?>" method="post">
        <div class="box-body">
          ...
          <div id="brand" class="form-group <?= form_error('brand_id') ? 'has-error' : '' ?>">
            <label for="brand_id" class="col-sm-3 control-label">Brand</label>
            <div class="col-sm-6">
              <select id="brand_id" class="form-control select2 select2-hidden-accessible" name="brand_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
              </select>
            </div>
            <span class="help-block"><?php echo form_error('brand_id'); ?></span>
          </div>
          <div id="divisi" class="form-group <?= form_error('divisi_id') ? 'has-error' : '' ?>">
            <label for="divisi_id" class="col-sm-3 control-label">Divisi</label>
            <div class="col-sm-6">
              <select id="divisi_id" class="form-control select2 select2-hidden-accessible" name="divisi_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
              </select>
            </div>
